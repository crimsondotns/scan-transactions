...
- ปุ่ม Slip ท้ายแผงขวา (คู่กับ View on explorer) → เปิดภาพสลิปแบบ **lightbox** (`SlipLightbox`: portal ไป body z 1100, ม่าน `--color-lightbox`, ภาพ 360px กลาง, ปุ่มปิดมุมขวาบน, แถบไอคอนใต้ภาพ Copy link / Print / Copy as image / Download PNG; Esc/คลิกม่านปิด) — ไม่ใช่ไดอะล็อก ไม่สลับเนื้อหาแผง; ตรวจสลิปจากไอคอนโล่บนหัว (`#/v/<code>.<data>` เปิดไดอะล็อกตรวจ)
