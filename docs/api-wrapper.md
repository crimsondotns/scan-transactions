...
4) ตั้งแหล่งข้อมูลในแอป

ช่อง Source URL / Token metadata URL / Chain list URL / Price URL ใส่ได้ 2 แบบ

- `https://…` — ยิงตรงเหมือนเดิม (ไม่มีกุญแจ หรือกุญแจของผู้ใช้เองที่เก็บในเครื่อง)
- `main/v1/transfers/{address}` — “ชื่อย่อ/path” = ผ่าน wrapper โดยกุญแจถูกเติมฝั่งเซิร์ฟเวอร์
  (เมื่อใช้รูปแบบนี้ แอปจะ **ไม่** ส่ง header กุญแจจากเบราว์เซอร์ แม้ตั้งไว้ในแหล่งนั้น)
