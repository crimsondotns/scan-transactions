 ...
 */
export function WalletPanel({ feeds, activeId, collapsed, onSwitch, onRemove, onToggle, hasSource }: { feeds: Record<string, WalletFeed>; activeId: string | null; collapsed: boolean; onSwitch: (id: string | null) => void; onRemove: (id: string) => void; onToggle: () => void; hasSource: (w: Wallet) => boolean }) {
  const { t } = useI18n();
