...
const th = {
  ...
  'wallets.view': 'รูปแบบ',
  'wallets.view.auto': 'อัตโนมัติ',
  'wallets.view.compact': 'กะทัดรัด',
  'wallets.view.list': 'รายการ',
  'wallets.view.card': 'การ์ด',
  'wallets.view.grid': 'ตาราง',
  'wallets.view.accordion': 'แอคคอร์เดียน',
  'wallets.expandRow': 'ขยาย {label}',
  'wallets.collapseRow': 'ย่อ {label}',
  'wallets.showInTable': 'ดูในตาราง',
  'wallets.recent': 'ธุรกรรมล่าสุด',
  'wallets.noTx': 'ยังไม่มีธุรกรรม',
...
const en: Record<MessageKey, string> = {
  ...
  'wallets.view': 'View',
  'wallets.view.auto': 'Auto',
  'wallets.view.compact': 'Compact',
  'wallets.view.list': 'List',
  'wallets.view.card': 'Card',
  'wallets.view.grid': 'Grid',
  'wallets.view.accordion': 'Accordion',
  'wallets.expandRow': 'Expand {label}',
  'wallets.collapseRow': 'Collapse {label}',
  'wallets.showInTable': 'Show in table',
  'wallets.recent': 'Recent transactions',
