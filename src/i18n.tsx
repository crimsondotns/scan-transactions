...
const th = {
  ...
  'settings.wrapperOn': 'มีตัวกลางฝั่งเซิร์ฟเวอร์ที่ {url} — ใส่แหล่งเป็น “ชื่อย่อ/path” ได้ กุญแจเก็บอยู่ที่นั่น ไม่ต้องใส่ในเครื่อง',
  'slip.title': 'สลิป',
  'slip.open': 'สลิป',
...
const en: Record<MessageKey, string> = {
  ...
  'settings.wrapperOn': 'A server-side relay is set up at {url} — a source can be written as “alias/path”; its key stays there, so you do not need to enter one here',
  'slip.title': 'Slip',
  'slip.open': 'Slip',
